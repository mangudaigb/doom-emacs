...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(;; ----------------------------------------------------------------
     ...
     (cmake :variables
            cmake-backend 'lsp
            cmke-enable-cmake-ide-support t)
     (java :variables
           java-backend 'lsp)
     (erlang :variables
             erlang-backend 'lsp)
     (kotlin :variables
             kotlin-backend 'lsp
             kotlin-lsp-jar-path "/Users/neo/opt/language-servers/bin/kotlin-language-server")
     (elixir :variables
             elixir-backend 'lsp
             ;; elixir-backend 'alchemist)
             elixir-ls-path "/Users/neo/opt/language-servers/elixir-ls-1.12")
     (html :variables
           css-enable-lsp t
           less-enable-lsp t
           scss-enable-lsp t
     ...
     ;; version-control
     (treemacs :variables
	       treemacs-persist-file "/Users/neo/.treemacs"
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; (default "%I@%S")
   dotspacemacs-frame-title-format "%a \u2B29 \u0950 \u2B29 %U"
